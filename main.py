...
def get_conversational_chain():
    ...
    if the answer is not in the provided context just say ," Answer is not in the porvided context", don't provide the 
    wrong answer.
...
def main():
    ...
    st.image("./demo.png", caption='Sunset', use_column_width=True)
